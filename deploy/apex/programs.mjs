...
export const PROGRAMS = [
  ...
  { n: 18, name: 'Starknet Seed Grants', chain: 'Starknet', amount: '~$25K', equity: '0%',
    ...
    evidence: 'probe: OPEN',
    note: '⛔ LIKELY DISQUALIFIED — program-requirements.md §1: Seed targets teams that "haven\'t yet gone to market", and explicitly excludes "mature projects already live on Starknet". starknet.xono.ai IS live, so being deployed is itself the disqualifier. Also requires KYC/KYB. Its low bar reads as good odds unless this is accounted for — do not treat it as an easy win. Growth (#29) is metrics-gated instead.' },
