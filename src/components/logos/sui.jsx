/**
 * Sui — official brand mark, real path data (simple-icons), monochrome.
 * The droplet outline plus the two interior crescents, knocked out of one
 * another by sub-path winding, so a flat currentColor fill keeps the volume.
 */
