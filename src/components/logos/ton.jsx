/**
 * TON — official brand mark, real path data (simple-icons), monochrome.
 * One path: the disc, the diamond knocked out of it by reversed winding, and
 * the two inner facets filled back in — which leaves the "T" stem, top bar and
 * bottom tip as negative space. Fill with currentColor and the glyph reads.
 */
